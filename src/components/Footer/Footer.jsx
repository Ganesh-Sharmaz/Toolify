            ...
            <div className="md:flex w-full pb-5">
                <div className="md:w-1/3 md:pr-7 flex flex-col md:block md:items-center">
                    ...
                    <ul className="py-3 flex gap-3">
                        ...
                        <li className="flex items-center justify-center cursor-pointer">
                            <svg
                                className="w-[25px] fill-[#595a5c] text-black  hover:fill-black   hover:text-blue-500  font-extrabold"
                                version="1.1"
                                viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                        ...
                        <li className="text-[#595a5c] cursor-pointer hover:text-black">
                            <Twitter />
                        </li>
                    </ul>
                </div>
                    ...
                    <div className=" flex-1 ">
                        ...
                        <ul className="md:text-[14px] md:space-y-1">
                            ...
                            <li>
                                ...
                                <NavLink to="/construction"><a className="border-b-1">Resume Builder </a></NavLink>
                            </li>
                        </ul>
                    </div>
                    <div className=" flex-1">
                        ...
                        <ul className="md:text-[14px] md:space-y-1 ">
                            ...
                            <li className="">
                                ...
                                <NavLink to="/about"><a className="border-b-1"> About </a></NavLink>
                            </li>
                            <li className="">
                                
                                <NavLink to="/contact">
                                    <a className="border-b-1"> Contact </a>
                                </NavLink>
                            </li>
                        </ul>
                    </div>
